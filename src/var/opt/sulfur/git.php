...
class GitRepo {
	...
	/**
	 * Runs a git fetch all on the current branch
	 *
	 * @access  public
	 * @return  string
	 */
	 ...
	 * @return  array
	 */
	public function list_remotes_full() {
		$remoteArray = explode("\n", $this->run("remote show -v"));

		return $remoteArray;
	}

	public function add_remote($name, $source)
	{
		$this->run("remote add $name $source");
	}
}
